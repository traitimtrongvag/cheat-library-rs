...
pub struct MonoString {
    ...
    pub length: i32,
    pub chars: [u16; 0], // Flexible array member
}
...
impl MonoString {
    pub fn get_string(&self) -> String {
        ...
        unsafe {
            let ptr = self.chars.as_ptr() as *const i8;
    ...
    pub fn set(&mut self, s: &str) {
        ...
        unsafe {
            ...
            std::ptr::copy_nonoverlapping(utf16.as_ptr() as *const i8, chars_ptr, utf16.len());
        }
    }

    pub fn get_chars(&self) -> *const u16 {
        self.chars.as_ptr() as *const i8
    }
...
pub struct MonoArray<T> {
    ...
    pub max_length: i32,
    pub vector: [T; 0], // Flexible array member
}
...
impl<T> MonoArray<T> {
    ...
    pub fn get_pointer(&self) -> *const T {
        self.vector.as_ptr() as *const i8
    }
